...
if(isset($_GET['delete'])){
   ...
   header("location: ./index.php?content=admin_page");
   ...
   <div class="product-display">
      <table class="product-display-table">
         ...
         <tr>
            ...
            <td>
               <a href="admin_update.php?edit=<?php echo $row['id']; ?>" class="btn"> <i class="fas fa-edit"></i> Bewerk </a>
               <a href="admin_page.php?delete=<?php echo $row['id']; ?>" class="btn"> <i class="fas fa-trash"></i> verwijderen </a>
            </td>
         </tr>
      <?php } ?>
      </table>
